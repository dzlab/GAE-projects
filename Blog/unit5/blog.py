...
application = webapp.WSGIApplication([('/unit5/blog', Blog),
                                      ('/unit5/blog.json', BlogJson),
                                      ('/unit5/.json', BlogJson),
                                      (r'/unit5/blog/(\d+)', PostHandler),
                                      (r'/unit5/blog/(\d+)\.json', PostJsonHandler),
                                      ('/unit5/newpost', NewPost),
                                      ('/unit5/signup', SignupHandler),
                                      ('/unit5/welcome', WelcomeHandler),
                                      ('/unit5/', WelcomeHandler),
                                      ('/unit5', WelcomeHandler),
                                      ('/unit5/login', LoginHandler),
                                      ('/unit5/logout', LogoutHandler)], debug=True)
